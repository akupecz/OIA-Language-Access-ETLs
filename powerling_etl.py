...
from config import SFTP_SECRET, POWERLING_DIRECTORY, AWS_DEV
import fabric 
...
def main():
    ...
    sftp_client = cgs.connect_with_secrets(sftp_utils.create_sftp_conn, SFTP_SECRET, dir=POWERLING_DIRECTORY)
    ...
    if sftp_utils.check_file_existence:
        ...
        local_name = 'POWERLING' + last_month + ext
        ...
        print(f'No file found in directory: {POWERLING_DIRECTORY}')
